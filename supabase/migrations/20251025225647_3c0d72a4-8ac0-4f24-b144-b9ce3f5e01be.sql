-- Drop e recriar fn_provisionar_nova_empresa com correções completas
DROP FUNCTION IF EXISTS fn_provisionar_nova_empresa(text, text);
...
BEGIN
  ...
  -- 5) Criar filial matriz
  INSERT INTO public.filiais (empresa_id, nome, tipo, ativa)
  VALUES (v_empresa_id, 'Matriz', 'MATRIZ', true)
  ...
  IF p_admin_email IS NOT NULL AND p_admin_email != '' THEN
    ...
    IF v_admin_user_id IS NOT NULL THEN
      -- Usuário já existe, vincular
      INSERT INTO public.usuarios_empresas (user_id, empresa_id, filial_id, role)
