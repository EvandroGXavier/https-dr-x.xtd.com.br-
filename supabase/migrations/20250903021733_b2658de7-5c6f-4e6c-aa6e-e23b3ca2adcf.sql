...
-- 5. Deletar contratos que referenciam contatos antigos (só cliente_contrato_id existe)
...
-- 12. Deletar relações de anexos que podem referenciar contatos
DELETE FROM public.anexo_relacoes WHERE 
  modulo = 'contatos' AND 
  record_id IN (SELECT id FROM public.contatos);

-- 13. Finalmente, deletar todos os contatos da tabela antiga
