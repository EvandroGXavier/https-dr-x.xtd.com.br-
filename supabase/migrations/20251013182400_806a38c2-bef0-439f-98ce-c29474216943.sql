-- Atualizar função RPC para remover campo ativo e adicionar etiqueta
...
BEGIN
  ...
  -- 1. Criar registro em contatos_v2 (SEM campo ativo)
  ...
  -- 5. Atribuir etiqueta "Ativo" ao contato
  -- Buscar ou criar etiqueta "Ativo"
  ...
  -- Se não existir, criar a etiqueta
  ...
  PERFORM public.log_security_event(
    ...
    jsonb_build_object(
      ...
      'etiqueta_ativo_id', v_etiqueta_ativo_id
    )
  );
