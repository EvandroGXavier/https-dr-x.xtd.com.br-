...
CREATE POLICY IF NOT EXISTS "Users can view their own contato_pf"
...
CREATE POLICY IF NOT EXISTS "Users can manage their own contato_pf"
...
CREATE POLICY IF NOT EXISTS "Users can view their own contato_pj"
...
CREATE POLICY IF NOT EXISTS "Users can manage their own contato_pj"
...
CREATE POLICY IF NOT EXISTS "Users can view their own contato_enderecos"
...
CREATE POLICY IF NOT EXISTS "Users can manage their own contato_enderecos"
...
CREATE POLICY IF NOT EXISTS "Users can view their own contato_meios_contato"
...
CREATE POLICY IF NOT EXISTS "Users can manage their own contato_meios_contato"
...
CREATE POLICY IF NOT EXISTS "Users can view their own contato_vinculos"
...
CREATE POLICY IF NOT EXISTS "Users can manage their own contato_vinculos"
...
CREATE POLICY IF NOT EXISTS "Users can view their own contato_documentos"
...
CREATE POLICY IF NOT EXISTS "Users can manage their own contato_documentos"
...
CREATE POLICY IF NOT EXISTS "Users can view their own contato_financeiro_config"
...
CREATE POLICY IF NOT EXISTS "Users can manage their own contato_financeiro_config"
