-- Função transacional para salvar/atualizar agenda completa
...
BEGIN
    ...
    IF (payload->>'id')::uuid IS NOT NULL THEN
        ...
        UPDATE agendas SET
            ...
            fluxo_id = (payload->>'fluxo_id')::uuid,
    ...
    ELSE
        ...
        INSERT INTO agendas (
            ...
            observacoes, processo_id, fluxo_id, empresa_id, filial_id, 
