-- Padronização PT-BR - Fase 1 Final: Views PT-BR compatíveis
-- Views para expor nomenclatura PT-BR mantendo compatibilidade com estrutura física
...
-- 2) Partes do Processo → View PT-BR (só colunas existentes)
...
COMMENT ON VIEW public.vw_processos_pt IS 'View PT-BR para processos jurídicos - nomenclatura amigável';
COMMENT ON VIEW public.vw_processo_partes_pt IS 'View PT-BR para partes do processo - nomenclatura amigável';
COMMENT ON VIEW public.vw_contatos_pt IS 'View PT-BR para contatos/clientes - nomenclatura amigável';
COMMENT ON VIEW public.vw_agenda_pt IS 'View PT-BR para agenda/compromissos - nomenclatura amigável';
COMMENT ON VIEW public.vw_transacoes_financeiras_pt IS 'View PT-BR para transações financeiras - nomenclatura amigável';
COMMENT ON VIEW public.vw_etiquetas_pt IS 'View PT-BR para etiquetas/tags - nomenclatura amigável';
COMMENT ON VIEW public.vw_anexos_pt IS 'View PT-BR para anexos/documentos - nomenclatura amigável';