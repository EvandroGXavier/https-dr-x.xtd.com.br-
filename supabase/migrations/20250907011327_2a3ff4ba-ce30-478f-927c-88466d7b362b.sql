-- Criar estrutura completa do sistema SaaS (corrigido)
...
-- 3. Tabela de perfis de usuário com empresa/filial
...
-- 6. Inserir evandro como SuperAdmin na tabela existente
INSERT INTO public.saas_superadmins (email) 
VALUES ('evandro@conectionmg.com.br')
ON CONFLICT (email) DO NOTHING;

-- 7. Atualizar perfil do evandro com empresa e filial master
...
-- 8. Inserir perfil de usuário para evandro
...
-- 10. Políticas RLS para SuperAdmins
