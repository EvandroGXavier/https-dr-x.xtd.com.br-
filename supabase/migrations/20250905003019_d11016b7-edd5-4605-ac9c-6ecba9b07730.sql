...
-- Create new restrictive policy that allows profile updates but prevents role changes through trigger
...
AS $function$
BEGIN
  -- Allow role changes only if this is coming from the change_user_role function
