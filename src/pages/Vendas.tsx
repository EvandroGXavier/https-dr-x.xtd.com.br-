    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Vendas / Saídas</h1>
            <p className="text-muted-foreground mt-1">
              Gerencie suas notas fiscais de saída e vendas
            </p>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => navigate('/relatorios/vendas')}>
